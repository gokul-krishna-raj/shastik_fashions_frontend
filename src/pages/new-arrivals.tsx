...
const NewArrivalsPage = () => {
  ...
  const handleSortChange = useCallback((newSort: string) => {
    ...
    dispatch(fetchProducts({ page: 1, sort: newSort, append: false, type: 'new-arrivals' }));
  }, [dispatch]);
  ...
  return (
    <>
      <NextSeo
        title="New Arrivals | Shastik Fashions"
        description="Discover the latest collection of sarees at Shastik Fashions."
      />
      <div className="flex flex-col bg-[#FFF9F5]">
        <div className="flex-1 p-4">
          <div className="flex justify-between items-center mb-6">
            <h1 className="text-3xl font-bold text-[#8A1538]">New Arrivals</h1>
